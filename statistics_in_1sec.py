...
def net_usage(inf = "ens18"):   #change the inf variable according to the interface
    ...
    net_usage_stats = {'net_recieved': net_in, 'net_sent': net_out, 'net_client_usage_w': int(net_client_transmit_bytes), 'net_client_usage_r': int(net_client_recieve_bytes)}
...
while True:
    ...
    statistics[file_name] = {'disk_io_usage': {'iostat_timestamp': iostat_timestamp, 'vda_io_usage_wrtn': vda_io_usage_wrtn, 'vda_io_usage_read': vda_io_usage_read}, \
                             ...
                             'net_usage_rates': {'net_recieved_KB': 0,'net_sent_KB': 0, 'net_client_recieved_KB': 0, 'net_client_sent_KB': 0} ,\
    ...
    try:
        with open(file_path,'r') as j:
            ...
            print('net_client_recieved_KB'+' '+str(statistics[key_name]['net_usage_rates']['net_client_recieved_KB']))
            print('\n')
